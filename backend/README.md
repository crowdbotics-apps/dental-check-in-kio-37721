...
## Project Structure
    ...
    ├── dental_check_in_kio_37721  # Django project configurations
...
1. Clone this repo and `cd dental_check_in_kio_37721`
...
2. Clone this repo and `cd dental_check_in_kio_37721`
